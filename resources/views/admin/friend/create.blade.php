...
-->
  ...
  <section class="content-wrap ecommerce-products">
    ...
    <!-- users -->
    <form class="card" action="{{ route('admin.friend.store') }}" method="POST">
      ...
      <div class="content">
        <table class="table table-hover">
          ...
          <tbody>
            ...
            <tr>
              <th>
                <input type="checkbox" id="chk{{$user->id}}" name="{{$user->id}}" />
              ...
              <!-- <td>
                <a href="/admin/user/{{$user->id}}" class="btn btn-small z-depth-0"><i class="mdi mdi-editor-mode-edit"></i></a>
              </td> -->
            </tr>
            @endforeach
