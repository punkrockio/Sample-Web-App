      ...
      <div class="contacts">
        ...
        <div class="nano">
          <div class="nano-content">
            ...
            <div class="user">
              <img src="/theme/admin/assets/_con/images/user3.jpg" alt="Max Brooks" class="circle photo">
            ...
            <div class="user">
              <img src="/theme/admin/assets/_con/images/user4.jpg" alt="Patsy Griffin" class="circle photo">
            ...
            <div class="user">
              <img src="/theme/admin/assets/_con/images/user5.jpg" alt="Chloe Morgan" class="circle photo">
            ...
            <div class="user">
              <img src="/theme/admin/assets/_con/images/user6.jpg" alt="Vernon Garrett" class="circle photo">
            ...
            <div class="user">
              <img src="/theme/admin/assets/_con/images/user7.jpg" alt="Greg Mcdonalid" class="circle photo">
            ...
            <div class="user">
              <img src="/theme/admin/assets/_con/images/user8.jpg" alt="Christian Jackson" class="circle photo">
            ...
            <div class="user">
              <img src="/theme/admin/assets/_con/images/user10.jpg" alt="Jenny Phillips" class="circle photo">
            ...
            <div class="user">
              <img src="/theme/admin/assets/_con/images/user11.jpg" alt="Darren Cunningham" class="circle photo">
            ...
            <div class="user">
              <img src="/theme/admin/assets/_con/images/user12.jpg" alt="Sandra Cole" class="circle photo">
