        ...
        <div class="content">
          ...
          <div class="row no-margin-top">
            ...
            <div class="col s12 l9">
              <div class="input-field no-margin-top">
                <input id="ecommerce-product-name" type="text" placeholder="" value="{{$user->name}}" name="name">
              </div>
            </div>
          </div>
          <!-- /Product Name -->
          ...
          <div class="row no-margin-top">
            ...
            <div class="col s12 l3">
              <div class="input-field">
                <input id="ecommerce-product-sku" type="text" value="{{$user->email}}" name="email">
                <label for="ecommerce-product-sku">Email</label>
              </div>
            </div>
            <div class="col s12 l3">
              <div class="input-field">
                <input id="ecommerce-product-price" type="text" value="{{$user->phone}}" name="phone">
                <label for="ecommerce-product-price">Phone</label>
              </div>
            </div>
            <div class="col s12 l3">
              <div class="input-field">
                <input id="ecommerce-product-stock" type="text" value="{{$user->facebook}}" name="facebook">
            ...
            <div class="col s12 l9">
              ...
              <div class="photos">
                <div class="main-photo">
                  <img class="materialboxed circle" width="150" src="{{$user->thumb_url}}">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row no-margin-top">
            ...
            <div class="col s12 l9">
              ...
              <textarea id="ckeditor1" name="product-description">{{$user->about}}</textarea>
